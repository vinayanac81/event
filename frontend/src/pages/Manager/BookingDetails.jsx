...
const BookingDetails = () => {
    ...
    const fetchDetails = async () => {
      try {
        ...
        if (data.success) {
          // console.log(data);
          setfilterData(data.data[0].form[0].items[0].categories);
          // console.log(data.data[0].form[0].items[0].categories);
          setdetails(data.data[0].form[0]);
          let find = data.data[0].form[0].items[0].categories;
          // console.log(find);
          // console.log(stageService);
          // console.log(filterData);
          stageIndex = find.findIndex((item) => item.category_name === "Stage");
